...
<body>
	...
	include 'koneksi.php';
		$id = $_GET['id'];
		$data = mysqli_query($koneksi,"SELECT * from anak where id = '$id'");
	while($d = mysqli_fetch_array($data)) {
		?>
		<form method="post" action="update_anak.php">
			<table align="center">
				<tr>
					<td>Kode</td>
                    <td>
				...
				<tr>
					<td></td>
					<td><input type="submit" value="SIMPAN">&nbsp;<input type="submit" value="KEMBALI"><a href = "update_anak.php"></td>
				</tr>
			</table>
		</form>
		<?php
