...
<body>
	...
	include 'koneksi.php';
		$id = $_GET['id'];
		$data = mysqli_query($koneksi,"SELECT * from kamus where id = '$id'");
	while($d = mysqli_fetch_array($data)) {
		?>
		<form method="post" action="update_kamus.php">
			<table align="center">
				<tr>
					<td>Kode</td>
                    <td>
				...
				<tr>
					<td></td>
					<td><input type="submit" value="SIMPAN">&nbsp;<input type="submit" value="KEMBALI"><a href = "update_kamus.php"></td>
				</tr>
			</table>
		</form>
		<?php
